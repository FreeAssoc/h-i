...
module DataHelper
  ...
  # Create the regions of the world
  def create_regions
...
module AuthHelper
  def http_login
    env ||= {}
    env['HTTP_AUTHORIZATION'] = ActionController::HttpAuthentication::Basic.encode_credentials('HIAPI','$tockh0lm')
    env
  end
end
